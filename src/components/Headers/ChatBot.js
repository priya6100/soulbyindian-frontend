        ...
        <div className="chatbot">
           ...
           {/* <button style={{float: "right"}} id="show">close</button>  */}
                ...
                <div className="chat-title">
                    <h1>flexi</h1> <a className="close" style={{float: "right", color: "white", fontSize: "30px", position: "relative", top: "-10px", right: "0"}} onclick="ClickON()">&times;</a>
                    
                    <h2>i am GNS chat bot, How may i help you <br/> <span id="time" style={{color: "green", fontWeight: "900", fontSize: "10px"}}></span></h2>
